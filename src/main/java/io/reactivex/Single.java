...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public static <T> Single<T> amb(
            @NonNull final Iterable<? extends SingleSource<? extends T>> sources) {
    ...
    public static <T> Single<T> ambArray(
            @NonNull final SingleSource<? extends T>... sources) {
        if (sources.length == 0) {
    ...
    public static <T> Flowable<T> concat(
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(sources,
                SingleInternalHelper.toFlowable(), prefetch,
                ErrorMode.IMMEDIATE));
    }
    ...
    public static <T> Single<T> defer(
            @NonNull final Callable<? extends SingleSource<? extends T>> singleSupplier) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> error(
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> error(@NonNull final Throwable exception) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> fromCallable(
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> fromPublisher(
            @NonNull final Publisher<? extends T> publisher) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> fromObservable(
            @NonNull ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull(observableSource,
                "observableSource is null");
        return RxJavaPlugins.onAssembly(new ObservableSingleSingle<T>(
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> just(@NonNull final T item) {
    ...
    public static <T> Flowable<T> merge(
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(sources,
                SingleInternalHelper.toFlowable(), false, Integer.MAX_VALUE,
                Flowable.bufferSize()));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public static Single<Long> timer(final long delay,
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<Boolean> equals(
            @NonNull final SingleSource<? extends T> first,
            @NonNull final SingleSource<? extends T> second) { // NOPMD
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T> Single<T> unsafeCreate(
    ...
    public static <T, U> Single<T> using(
            @NonNull Callable<U> resourceSupplier,
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, U> Single<T> using(
            @NonNull final Callable<U> resourceSupplier,
            @NonNull final Function<? super U, ? extends SingleSource<? extends T>> singleFunction,
            @NonNull final Consumer<? super U> disposer, final boolean eager) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Single<U> cast(@NonNull final Class<? extends U> clazz) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Single<T> delay(final long time, @NonNull final TimeUnit unit,
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<T> doOnSubscribe(@NonNull final Consumer<? super Disposable> onSubscribe) {
        ObjectHelper.requireNonNull(onSubscribe, "onSubscribe is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<T> doOnSuccess(@NonNull final Consumer<? super T> onSuccess) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<T> doOnEvent(@NonNull final BiConsumer<? super T, ? super Throwable> onEvent) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<T> doOnError(@NonNull final Consumer<? super Throwable> onError) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Maybe<R> flatMapMaybe(@NonNull final Function<? super T, ? extends MaybeSource<? extends R>> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Flowable<U> flattenAsFlowable(@NonNull final Function<? super T, ? extends Iterable<? extends U>> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Observable<U> flattenAsObservable(@NonNull final Function<? super T, ? extends Iterable<? extends U>> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Completable flatMapCompletable(@NonNull final Function<? super T, ? extends CompletableSource> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Single<R> lift(@NonNull final SingleOperator<? extends R, ? super T> lift) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<Boolean> contains(@NonNull final Object value,
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @Override
    public final void subscribe(@NonNull SingleObserver<? super T> subscriber) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <E extends SingleObserver<? super T>> E subscribeWith(@NonNull E observer) {
        subscribe(observer);
        return observer;
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Single<T> subscribeOn(@NonNull final Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<T> takeUntil(@NonNull final CompletableSource other) {
        ObjectHelper.requireNonNull(other, "other is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <E> Single<T> takeUntil(@NonNull final Publisher<E> other) {
        ObjectHelper.requireNonNull(other, "other is null");
    ...
    private Single<T> timeout0(final long timeout,
                               @NonNull final TimeUnit unit, @NonNull final Scheduler scheduler,
                               @NonNull final SingleSource<? extends T> other) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U, R> Single<R> zipWith(@NonNull SingleSource<U> other,
